 ...
 * @author HP Pavilion
 */
public class TEST_Periode implements InterfacePeriode{
    public int id;
    ...
    public TEST_Periode(int id, int idEntreprise, int idUtilisateur, int idExercice, String nom, Date debut, Date fin, long signature, int beta) {
        this.id = id;
